...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bundle.putString("fullname", "Ronald Miya");
        mFirebaseAnalytics.logEvent(FirebaseAnalytics.Event.APP_OPEN, bundle);

        mFirebaseAnalytics.setUserProperty("username", "rMiya");
...
//        getIntent().getExtras().getString("NO_EXISTE").getBytes();
    ...
    public void showRegister(View view) {
        ...
        startActivityForResult(new Intent(this, RegisterActiivity.class), REGISTER_FORM_REQUEST);
