...
public class RegisterActiivity extends AppCompatActivity {
    ...
    private static final String TAG = RegisterActiivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_register_actiivity);
        ...
        postRef.setValue(post)
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            Log.d(TAG, "onSuccess");
                            Toast.makeText(RegisterActiivity.this, "Registro guardado", Toast.LENGTH_SHORT).show();
                            finish();
                        } else {
                            Log.e(TAG, "onFailure", task.getException());
                            Toast.makeText(RegisterActiivity.this, "Error al guardar", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
                    ...
                    Toast.makeText(RegisterActiivity.this, "Error al cargar", Toast.LENGTH_SHORT).show();
                }
            }
        });
            ...
            if(!Nammu.hasPermission(this, permissions)){
                Nammu.askForPermission(this, permissions, new PermissionCallback() {
                    ...
                    public void permissionGranted() {
                        ...
                        EasyImage.openChooserWithGallery(RegisterActiivity.this, "Seleccione una imagen…", 0);
                    }

                    @Override
                    public void permissionRefused() {
                        Log.d(TAG, "permissionRefused");
                        Toast.makeText(RegisterActiivity.this, "No ha concedido el permiso", Toast.LENGTH_SHORT).show();
                    }
                });
                return;
            }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        EasyImage.handleActivityResult(requestCode, resultCode, data, this, new DefaultCallback() {
            ...
            public void onImagePicked(File file, EasyImage.ImageSource imageSource, int i) {
                ...
                Picasso.with(RegisterActiivity.this).load(resizedFile).into(imagenPreview);
            ...
            public void onCanceled(EasyImage.ImageSource source, int type) {
                ...
                if (source == EasyImage.ImageSource.CAMERA) {
                    File photoFile = EasyImage.lastlyTakenButCanceledPhoto(RegisterActiivity.this);
